...
layui.define(['jquery', 'laytpl', 'jqajax', 'laypage', 'jqform', 'jqbind'], function (exports) {
    ...
    jqtable.prototype.init = function (conf) {
        ...
        ajax.complete = function (ret) {
            ...
            _this.options.pageTotal = ret.result.total;
            if (_this.options.server) {
                _this.options.pages = ret.result.pages;
                _this.options.list = ret.result;
                _this.render();

            } else {
                _this.options.record = ret.result;
    ...
    jqtable.prototype.pageInfo = function () {
        var _this = this;
        var html = 'a total of ' + _this.options.pageTotal + ' data/each page <div class="layui-form page-num"><select name="pageNum" lay-filter="pageNum">';
