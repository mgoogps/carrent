...
namespace Mgoo.CarRent.Common.Lib
{
    public class Config
    {
        ...
        public class SMS
        {
            ...
            /// 存到cache 的key开头
            /// </summary>
            public const string PREFIX = "SMS_";
            /// <summary>
            /// 创蓝253 国际短信接口 账号
            /// </summary>
            public const string CHUANLAN_ACCOUNT = "I6313616";
            /// <summary>
            /// 创蓝253 国际短信接口 密码
            /// </summary>
            public const string CHUANLAN_PASSWORD = "f3arA7QX5o567f";

            /// <summary>
            /// 短信签名
            /// </summary>
            public const string SIGNATURE = "【MGOO】";

            /// <summary>
            /// 国际区号数组
            /// </summary>
            public readonly string[] InternationalCode = new string[]
            #region 国际区号 
            {
                  "Angola-安哥拉-0244",
                  "Afghanistan-阿富汗-93",
